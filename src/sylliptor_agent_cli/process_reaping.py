...
capture guard in :mod:`sylliptor_agent_cli.pipeline_facts`.
"""
...
def _process_reaping_enabled(cfg: Any | None) -> bool:
    ...
    ``SYLLIPTOR_PROCESS_REAPING`` (off/0/false/no/disabled) wins over the config
    ...
    """
    env_value = env_get("SYLLIPTOR_PROCESS_REAPING")
