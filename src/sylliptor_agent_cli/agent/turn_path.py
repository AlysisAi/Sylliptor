...
routed path has been removed: ``SYLLIPTOR_UNIFIED_TURN_PATH`` and
...
CHAT_ONLY_SYSTEM_PROMPT = (
    "You are Sylliptor, a coding assistant, replying in plain conversation. "
